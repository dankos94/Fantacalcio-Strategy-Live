...
export const ConfigurationPage = () => {
  ...
  return (
    <div>
      ...
      <span>Filtro (per prefisso)</span> <Input type="search" value={filter} onChange={changeFilter} name="search" id="search" />
      <label>Spring configuration</label>
      <Table className="table table-striped table-bordered table-responsive d-table">
        <thead>
          <tr>
            <th onClick={changeReversePrefix}>Prefisso</th>
            <th onClick={changeReverseProperties}>Proprietà</th>
          </tr>
        </thead>
        <tbody>
