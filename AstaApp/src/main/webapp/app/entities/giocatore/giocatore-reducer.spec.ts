...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './giocatore.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GIOCATORE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GIOCATORE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GIOCATORE actions', async () => {
      const arg = { id: 21686 };
    ...
    it('dispatches UPDATE_GIOCATORE actions', async () => {
      const arg = { id: 21686 };
    ...
    it('dispatches PARTIAL_UPDATE_GIOCATORE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GIOCATORE actions', async () => {
      const arg = 42666;
