...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './squadra.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SQUADRA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SQUADRA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SQUADRA actions', async () => {
      const arg = { id: 29608 };
    ...
    it('dispatches UPDATE_SQUADRA actions', async () => {
      const arg = { id: 29608 };
    ...
    it('dispatches PARTIAL_UPDATE_SQUADRA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SQUADRA actions', async () => {
      const arg = 42666;
