...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './lega.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEGA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEGA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEGA actions', async () => {
      const arg = { id: 2028 };
    ...
    it('dispatches UPDATE_LEGA actions', async () => {
      const arg = { id: 2028 };
    ...
    it('dispatches PARTIAL_UPDATE_LEGA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEGA actions', async () => {
      const arg = 42666;
