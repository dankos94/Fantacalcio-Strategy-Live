...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './roster.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROSTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROSTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROSTER actions', async () => {
      const arg = { id: 13633 };
    ...
    it('dispatches UPDATE_ROSTER actions', async () => {
      const arg = { id: 13633 };
    ...
    it('dispatches PARTIAL_UPDATE_ROSTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ROSTER actions', async () => {
      const arg = 42666;
