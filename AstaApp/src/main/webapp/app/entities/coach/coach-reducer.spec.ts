...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './coach.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<ICoach> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COACH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COACH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COACH actions', async () => {
      const arg = { id: 31551 };
    ...
    it('dispatches UPDATE_COACH actions', async () => {
      const arg = { id: 31551 };
    ...
    it('dispatches PARTIAL_UPDATE_COACH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COACH actions', async () => {
      const arg = 42666;
