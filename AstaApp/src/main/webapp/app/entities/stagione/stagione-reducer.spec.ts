...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './stagione.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STAGIONE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STAGIONE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STAGIONE actions', async () => {
      const arg = { id: 19687 };
    ...
    it('dispatches UPDATE_STAGIONE actions', async () => {
      const arg = { id: 19687 };
    ...
    it('dispatches PARTIAL_UPDATE_STAGIONE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STAGIONE actions', async () => {
      const arg = 42666;
