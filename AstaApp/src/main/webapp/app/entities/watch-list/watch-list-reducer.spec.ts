...
import { IWatchList, defaultValue } from 'app/shared/model/watch-list.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IWatchList> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATCHLIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WATCHLIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WATCHLIST actions', async () => {
      const arg = { id: 1855 };
    ...
    it('dispatches UPDATE_WATCHLIST actions', async () => {
      const arg = { id: 1855 };
    ...
    it('dispatches PARTIAL_UPDATE_WATCHLIST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WATCHLIST actions', async () => {
      const arg = 42666;
